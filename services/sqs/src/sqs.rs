...
MessageNotInflight(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl ChangeMessageVisibilityError {
                    pub fn from_body(body: &str) -> ChangeMessageVisibilityError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ReceiptHandleIsInvalid" => ChangeMessageVisibilityError::ReceiptHandleIsInvalid(String::from(parsed_error.message)),"MessageNotInflight" => ChangeMessageVisibilityError::MessageNotInflight(String::from(parsed_error.message)),_ => ChangeMessageVisibilityError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ChangeMessageVisibilityError {
                    fn description(&self) -> &str {
                        match *self {
                            ChangeMessageVisibilityError::ReceiptHandleIsInvalid(ref cause) => cause,ChangeMessageVisibilityError::MessageNotInflight(ref cause) => cause,ChangeMessageVisibilityError::Validation(ref cause) => cause,ChangeMessageVisibilityError::Credentials(ref err) => err.description(),ChangeMessageVisibilityError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ChangeMessageVisibilityError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl ChangeMessageVisibilityBatchError {
                    pub fn from_body(body: &str) -> ChangeMessageVisibilityBatchError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidBatchEntryId" => ChangeMessageVisibilityBatchError::InvalidBatchEntryId(String::from(parsed_error.message)),"TooManyEntriesInBatchRequest" => ChangeMessageVisibilityBatchError::TooManyEntriesInBatchRequest(String::from(parsed_error.message)),"BatchEntryIdsNotDistinct" => ChangeMessageVisibilityBatchError::BatchEntryIdsNotDistinct(String::from(parsed_error.message)),"EmptyBatchRequest" => ChangeMessageVisibilityBatchError::EmptyBatchRequest(String::from(parsed_error.message)),_ => ChangeMessageVisibilityBatchError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for ChangeMessageVisibilityBatchError {
                    fn description(&self) -> &str {
                        match *self {
                            ChangeMessageVisibilityBatchError::EmptyBatchRequest(ref cause) => cause,ChangeMessageVisibilityBatchError::BatchEntryIdsNotDistinct(ref cause) => cause,ChangeMessageVisibilityBatchError::TooManyEntriesInBatchRequest(ref cause) => cause,ChangeMessageVisibilityBatchError::InvalidBatchEntryId(ref cause) => cause,ChangeMessageVisibilityBatchError::Validation(ref cause) => cause,ChangeMessageVisibilityBatchError::Credentials(ref err) => err.description(),ChangeMessageVisibilityBatchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),ChangeMessageVisibilityBatchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl CreateQueueError {
                    pub fn from_body(body: &str) -> CreateQueueError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "QueueNameExists" => CreateQueueError::QueueNameExists(String::from(parsed_error.message)),"QueueDeletedRecently" => CreateQueueError::QueueDeletedRecently(String::from(parsed_error.message)),_ => CreateQueueError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for CreateQueueError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateQueueError::QueueNameExists(ref cause) => cause,CreateQueueError::QueueDeletedRecently(ref cause) => cause,CreateQueueError::Validation(ref cause) => cause,CreateQueueError::Credentials(ref err) => err.description(),CreateQueueError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),CreateQueueError::Unknown(ref cause) => cause
                        }
                    }
                 }
                ...
                impl DeleteMessageError {
                    pub fn from_body(body: &str) -> DeleteMessageError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ReceiptHandleIsInvalid" => DeleteMessageError::ReceiptHandleIsInvalid(String::from(parsed_error.message)),"InvalidIdFormat" => DeleteMessageError::InvalidIdFormat(String::from(parsed_error.message)),_ => DeleteMessageError::Unknown(String::from(body))
                                }
                           },
...
Unknown(String)
                ...
                impl DeleteMessageBatchError {
                    pub fn from_body(body: &str) -> DeleteMessageBatchError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BatchEntryIdsNotDistinct" => DeleteMessageBatchError::BatchEntryIdsNotDistinct(String::from(parsed_error.message)),"InvalidBatchEntryId" => DeleteMessageBatchError::InvalidBatchEntryId(String::from(parsed_error.message)),"TooManyEntriesInBatchRequest" => DeleteMessageBatchError::TooManyEntriesInBatchRequest(String::from(parsed_error.message)),"EmptyBatchRequest" => DeleteMessageBatchError::EmptyBatchRequest(String::from(parsed_error.message)),_ => DeleteMessageBatchError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for DeleteMessageBatchError {
                    fn description(&self) -> &str {
                        match *self {
                            DeleteMessageBatchError::TooManyEntriesInBatchRequest(ref cause) => cause,DeleteMessageBatchError::EmptyBatchRequest(ref cause) => cause,DeleteMessageBatchError::BatchEntryIdsNotDistinct(ref cause) => cause,DeleteMessageBatchError::InvalidBatchEntryId(ref cause) => cause,DeleteMessageBatchError::Validation(ref cause) => cause,DeleteMessageBatchError::Credentials(ref err) => err.description(),DeleteMessageBatchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),DeleteMessageBatchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
Unknown(String)
                ...
                impl Error for PurgeQueueError {
                    fn description(&self) -> &str {
                        match *self {
                            PurgeQueueError::PurgeQueueInProgress(ref cause) => cause,PurgeQueueError::QueueDoesNotExist(ref cause) => cause,PurgeQueueError::Validation(ref cause) => cause,PurgeQueueError::Credentials(ref err) => err.description(),PurgeQueueError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),PurgeQueueError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
InvalidMessageContents(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl SendMessageError {
                    pub fn from_body(body: &str) -> SendMessageError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "UnsupportedOperation" => SendMessageError::UnsupportedOperation(String::from(parsed_error.message)),"InvalidMessageContents" => SendMessageError::InvalidMessageContents(String::from(parsed_error.message)),_ => SendMessageError::Unknown(String::from(body))
                                }
                           },
...
///<p>The <code>Id</code> of a batch entry in a batch request doesn't abide by the specification.</p>
InvalidBatchEntryId(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl SendMessageBatchError {
                    pub fn from_body(body: &str) -> SendMessageBatchError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "TooManyEntriesInBatchRequest" => SendMessageBatchError::TooManyEntriesInBatchRequest(String::from(parsed_error.message)),"BatchRequestTooLong" => SendMessageBatchError::BatchRequestTooLong(String::from(parsed_error.message)),"UnsupportedOperation" => SendMessageBatchError::UnsupportedOperation(String::from(parsed_error.message)),"InvalidBatchEntryId" => SendMessageBatchError::InvalidBatchEntryId(String::from(parsed_error.message)),"EmptyBatchRequest" => SendMessageBatchError::EmptyBatchRequest(String::from(parsed_error.message)),"BatchEntryIdsNotDistinct" => SendMessageBatchError::BatchEntryIdsNotDistinct(String::from(parsed_error.message)),_ => SendMessageBatchError::Unknown(String::from(body))
                                }
                           },
                ...
                impl Error for SendMessageBatchError {
                    fn description(&self) -> &str {
                        match *self {
                            SendMessageBatchError::EmptyBatchRequest(ref cause) => cause,SendMessageBatchError::TooManyEntriesInBatchRequest(ref cause) => cause,SendMessageBatchError::BatchRequestTooLong(ref cause) => cause,SendMessageBatchError::UnsupportedOperation(ref cause) => cause,SendMessageBatchError::InvalidBatchEntryId(ref cause) => cause,SendMessageBatchError::BatchEntryIdsNotDistinct(ref cause) => cause,SendMessageBatchError::Validation(ref cause) => cause,SendMessageBatchError::Credentials(ref err) => err.description(),SendMessageBatchError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),SendMessageBatchError::Unknown(ref cause) => cause
                        }
                    }
                 }
...
/// A client for the Amazon SQS API.
        ...
        impl<P, D> SqsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            pub fn new(request_dispatcher: D, credentials_provider: P, region: region::Region) -> Self {
                ...
                pub fn add_permission(&self, input: &AddPermissionRequest) -> Result<(), AddPermissionError> {
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(AddPermissionError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn change_message_visibility(&self, input: &ChangeMessageVisibilityRequest) -> Result<(), ChangeMessageVisibilityError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(ChangeMessageVisibilityError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn change_message_visibility_batch(&self, input: &ChangeMessageVisibilityBatchRequest) -> Result<ChangeMessageVisibilityBatchResult, ChangeMessageVisibilityBatchError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(ChangeMessageVisibilityBatchError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn create_queue(&self, input: &CreateQueueRequest) -> Result<CreateQueueResult, CreateQueueError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(CreateQueueError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn delete_message(&self, input: &DeleteMessageRequest) -> Result<(), DeleteMessageError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(DeleteMessageError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn delete_message_batch(&self, input: &DeleteMessageBatchRequest) -> Result<DeleteMessageBatchResult, DeleteMessageBatchError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(DeleteMessageBatchError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn delete_queue(&self, input: &DeleteQueueRequest) -> Result<(), DeleteQueueError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(DeleteQueueError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn get_queue_attributes(&self, input: &GetQueueAttributesRequest) -> Result<GetQueueAttributesResult, GetQueueAttributesError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(GetQueueAttributesError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn get_queue_url(&self, input: &GetQueueUrlRequest) -> Result<GetQueueUrlResult, GetQueueUrlError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(GetQueueUrlError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn list_dead_letter_source_queues(&self, input: &ListDeadLetterSourceQueuesRequest) -> Result<ListDeadLetterSourceQueuesResult, ListDeadLetterSourceQueuesError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(ListDeadLetterSourceQueuesError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn list_queues(&self, input: &ListQueuesRequest) -> Result<ListQueuesResult, ListQueuesError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(ListQueuesError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn purge_queue(&self, input: &PurgeQueueRequest) -> Result<(), PurgeQueueError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(PurgeQueueError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn receive_message(&self, input: &ReceiveMessageRequest) -> Result<ReceiveMessageResult, ReceiveMessageError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(ReceiveMessageError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn remove_permission(&self, input: &RemovePermissionRequest) -> Result<(), RemovePermissionError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(RemovePermissionError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn send_message(&self, input: &SendMessageRequest) -> Result<SendMessageResult, SendMessageError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(SendMessageError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn send_message_batch(&self, input: &SendMessageBatchRequest) -> Result<SendMessageBatchResult, SendMessageBatchError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
        ...
        if response.body.is_empty() {
            ...
            try!(start_element(&actual_tag_name, &mut stack));
                     ...
                     try!(end_element(&actual_tag_name, &mut stack));
                        ...
                        _ => {
                            Err(SendMessageBatchError::from_body(&response.body))
                        }
                    }
                }
                ...
                pub fn set_queue_attributes(&self, input: &SetQueueAttributesRequest) -> Result<(), SetQueueAttributesError> {
                    let mut request = SignedRequest::new("POST", "sqs", self.region, "/");
                    let mut params = Params::new();
                    ...
                    match response.status {
                        ...
                        _ => {
                            Err(SetQueueAttributesError::from_body(&response.body))
                        }
                    }
                }
        ...
        fn test_parse_sqs_list_queues() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-list-queues.xml");
        ...
        fn test_parse_sqs_get_queue_url() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-get-queue-url.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_change_message_visibility_batch() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-change-message-visibility-batch.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_add_permission() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-add-permission.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_create_queue() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-create-queue.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_receive_message() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-receive-message.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_delete_message_batch() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-delete-message-batch.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_send_message() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-send-message.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_get_queue_attributes() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-get-queue-attributes.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_sqs_send_message_batch() {
            let mock_response =  MockResponseReader::read_response(r#"/home/adimarco/code/rusoto/codegen/botocore/tests/unit/response_parsing/xml/responses/"#, "sqs-send-message-batch.xml");
            let mock = MockRequestDispatcher::with_status(200)
                .with_body(&mock_response);
            let client = SqsClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
